...
// ============================================================
/**
 * Rileva la categoria dal nome del prodotto con sistema di punteggio
 */
function detectCategoryFromName(name) {
  ...
  for (var d = 0; d < dairyKw.length; d++) {
    if (text.indexOf(dairyKw[d]) !== -1) scores.dairy += 10;
  }
  ...
  for (var m = 0; m < meatKw.length; m++) {
    if (text.indexOf(meatKw[m]) !== -1) scores.meat += 10;
  }
  ...
  for (var p = 0; p < produceKw.length; p++) {
    if (text.indexOf(produceKw[p]) !== -1) scores.produce += 10;
  }
  ...
  for (var b = 0; b < beverageKw.length; b++) {
    if (text.indexOf(beverageKw[b]) !== -1) scores.beverages += 10;
  }
  ...
  for (var f = 0; f < frozenKw.length; f++) {
    if (text.indexOf(frozenKw[f]) !== -1) scores.frozen += 10;
  }
  ...
  for (var ba = 0; ba < bakeryKw.length; ba++) {
    if (text.indexOf(bakeryKw[ba]) !== -1) scores.bakery += 10;
  }
  ...
  for (var s = 0; s < sweetsKw.length; s++) {
    if (text.indexOf(sweetsKw[s]) !== -1) scores.sweets += 10;
  }
...
function addProduct() {
  ...
  // Rileva categoria dal nome (per prodotti manuali)
